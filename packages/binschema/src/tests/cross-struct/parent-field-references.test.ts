...
// Note: Basic parent_field_reference_length test is in composite/parent-field-reference.test.ts
// This file contains additional cross-struct reference patterns.
